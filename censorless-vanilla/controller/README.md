...
```sh
    ...
    sudo docker run -e  AWS_ACCESS_KEY_ID=<your-key-id> -e AWS_SECRET_ACCESS_KEY=<your-access-key> -it -p 8000:8000 --cap-add=NET_ADMIN --name=controller controller-image
```
